...
import com.catalis.core.product.core.services.fee.v1.ProductFeeStructureCreateService;
import com.catalis.core.product.core.services.fee.v1.ProductFeeStructureDeleteService;
import com.catalis.core.product.core.services.fee.v1.ProductFeeStructureGetService;
import com.catalis.core.product.core.services.fee.v1.ProductFeeStructureUpdateService;
...
public class ProductFeeStructureController {
     ...
     * @return A ResponseEntity containing the ProductFeeStructureDTO.
     */
    ...
    public Mono<ResponseEntity<ProductFeeStructureDTO>> getProductFeeStructure(@PathVariable Long productFeeStructureId) {
     ...
     * @return A ResponseEntity containing a PaginationResponse of ProductFeeStructureDTOs.
     */
    ...
    public Mono<ResponseEntity<PaginationResponse<ProductFeeStructureDTO>>> findByProductId(
     ...
     * @return A ResponseEntity containing the created ProductFeeStructureDTO.
     */
    ...
    @PostMapping
    public Mono<ResponseEntity<ProductFeeStructureDTO>> createProductFeeStructure(@RequestBody ProductFeeStructureDTO request) {
     ...
     * @return A ResponseEntity containing the updated ProductFeeStructureDTO.
     */
    ...
    @PutMapping("/{id}")
    public Mono<ResponseEntity<ProductFeeStructureDTO>> updateProductFeeStructure(@PathVariable Long id, @RequestBody ProductFeeStructureDTO request) {
     ...
     *
     * @param id The Product Fee Structure ID.
     * @return A ResponseEntity completing upon successful deletion.
     */
    ...
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteProductFeeStructure(@PathVariable Long id) {
